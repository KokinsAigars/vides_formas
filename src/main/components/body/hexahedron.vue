...
<script setup lang="ts">
  ...
  const add_Images = ref<boolean>(false);

  const unique_geo_path = 'h/hexahedron';
  const unique_img_path = 'h/h';
  const unique_number_of_images = ref<number>(0);

  const unique_gps = '56°34\'18.9"N 23°04\'24.6"E';
  const unique_gps_path = 'https://www.google.com/maps/place/56%C2%B034\'18.9%22N+23%C2%B004\'24.4%22E/@56.538207,22.9568711,69057m'

  const unique_svgMarkerD_color = "black";
  const unique_svgMarkerH_color = "blue";
