...
//  UNIQUE for ICOSAHEDRON

const unique_geometry = ref<string>(null);
unique_geometry.value = 'icosahedron';

const add_Images = ref<boolean>(true);

const unique_geo_path = 'i/icosahedron';
const unique_img_path = 'i/i';
const unique_number_of_images = ref<number>(2);

const unique_gps = '57°52\'18.5"N 25°00\'20.7"E';
const unique_gps_path = 'https://www.google.com/maps/place/57%C2%B052\'18.5%22N+25%C2%B000\'20.7%22E/@57.8718056,25.00575,789m'

const unique_svgMarkerD_color = "black";
const unique_svgMarkerH_color = "black";
const unique_svgMarkerI_color = "blue";
