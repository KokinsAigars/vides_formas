...
//  UNIQUE for TETRAHEDRON

const unique_geometry = ref<string>(null);
unique_geometry.value = 'tetrahedron';

const add_Images = ref<boolean>(true);

const unique_geo_path = 't/tetrahedron';
const unique_img_path = 't/t';
const unique_number_of_images = ref<number>(3);

const unique_gps = '57°00\'57.4"N 21°34\'51.1"E';
const unique_gps_path = 'https://www.google.com/maps/place/57%C2%B000\'57.4%22N+21%C2%B034\'51.1%22E/@57.0158943,21.5796273,781m'
...
const unique_svgMarkerT_color = "blue";
